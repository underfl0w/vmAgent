...
public class StorageApiServiceImpl extends StorageApiService {
    ...
    @Override
    public Response postStoragePool(String name, String hostname, String devicePath, String authtype, String username, String secret, String path, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
